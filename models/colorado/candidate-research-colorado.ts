...
import { buildColoradoCandidatePlan, buildResearchBrief, buildSourcePacket, ResearchBriefSchema, ResearchPlanSchema, SourcePacketSchema, SourceSpecSchema, slugify } from "../shared/candidate-research-shared.ts";
